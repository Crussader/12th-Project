...
class Message:
    ...
    @classmethod
    def create(cls, type_: str, message: str, yes_no=False, yes_command = None, no_command = None):
    ...
    @classmethod
    def show_info(cls, message: str, yes_no=False, yes_command=None, no_command=None):
...
class Login:
    ...
    def _sign_up(self,fields):
        ...
        data = {k.strip('*'): func(v)[1].entry.get()
                ...
                for k, v in fields}
        utils.fade_in_out(self.root, Message.show_info,
        ...
        #                   "of Use and Privacy Policy of {}".format(self.main.APPNAME),
        #                   yes_no=True, yes_command=self.root.destroy)
